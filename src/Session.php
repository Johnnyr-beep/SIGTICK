...
class Session
{
     ...
     * Modificado: siempre retorna el idioma configurado en GLPI (es_CO),
     * ignorando el idioma del navegador para garantizar español Colombia en todos los perfiles.
     *
     * @return string
     */
    public static function getPreferredLanguage(): string
    {
        ...
        if (isset($CFG_GLPI['language'])) {
            // Usar siempre el idioma configurado en GLPI (español Colombia)
            return $CFG_GLPI['language'];
        } elseif (isset($CFG_GLPI['default_language'])) {
            // Config anterior a GLPI 0.72
