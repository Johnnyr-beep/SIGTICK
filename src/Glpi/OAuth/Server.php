...
final class Server
{
    ...
    private static function doGenerateKeys(): void
    {
        ...
        // On Windows (e.g. XAMPP), openssl_pkey_new() fails with "No such process"
        // if it cannot find openssl.cnf. Passing the 'config' key directly bypasses
        // the environment variable lookup and works at runtime.
